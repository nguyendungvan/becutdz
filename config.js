module.exports = {
	...
	adminId: "457074467319840768", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTE4MTkyNDEwNjY4NjQzNTMzOA.GdGgUd.n538R1VGEhW9B4tbpuDZYMUlh5xG_-poXwbZZo", //- Bot's Token
	clientId: process.env.clientId || "1181924106686435338", //- ID of the bot
	clientSecret: process.env.clientSecret || "xeXL77vA-CrwT5so_GBtIvkwrBj61t4y", //- Client Secret of the bot
	port: 4200, //- Port of the API and Dashboard
	scopes: ["identify", "guilds", "applications.commands"], //- Discord OAuth2 Scopes
	inviteScopes: ["bot", "applications.commands"], // Invite link scopes
	serverDeafen: true, //- If you want bot to stay deafened
	defaultVolume: 100, //- Sets the default volume of the bot, You can change this number anywhere from 1 to 100
	supportServer: "<@277548067115499520>", //- Support Server Link
	Issues: "<@277548067115499520>", //- Bug Report Link
	...
	cookieSecret: "Cutdzvclhihi", //- Cookie Secret
	...
	presence: {
		...
		activities: [
			{
				name: "cùng tớ nhaaa", //- Status Text
